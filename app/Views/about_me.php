...
<head>
    ...
    <title>About Me - AkuOnline</title>
            ...
            <ul>
                ...
                <li class="mt-3" style="list-style: none;">
                    ...
                    <ul>
                        ...
                        <li>Job Description :
                            <ul>
                                <li>Create a development plan for an application that help business operation from receiving order until print the invoice.</li>
                                <li>Develop the application for local environment with internet access and integration to google sheets API</li>
                                <li>Educate the client on the completed application about how to operate until how to handle common errors.</li>
                            </ul>
                        </li>
                    </ul>
                </li>
                <li class="mt-3" style="list-style: none;">
                    ...
                    <ul>
                        ...
                        <li>Job Description :
                            <ul>
                                <li>Design and develop web application to manage project assignments to every related workforce in the company.</li>
                                <li>Collaborate with related teams to prepare the system so that it can be implemented on server in the corporate network.</li>
                            </ul>
                        </li>
                    </ul>
                </li>
        ...
        <div class="container-md my-md-4 py-4" style="max-width:1080px">
            ...
            <ul style="list-style: none;">
                <li>
                    ...
                    <img class="mb-2" src="https://img.shields.io/static/v1?label=%20&message=Git&color=F05032&style=for-the-badge&logo=Git&logoColor=F05032&labelColor=ddd"> &nbsp;
                    <img class="mb-2" src="https://img.shields.io/static/v1?label=%20&message=Postman&color=FF6C37&style=for-the-badge&logo=Postman&logoColor=FF6C37&labelColor=ddd"> &nbsp;
                    <img class="mb-2" src="https://img.shields.io/static/v1?label=%20&message=phpmyadmin&color=6C78AF&style=for-the-badge&logo=phpmyadmin&logoColor=6C78AF&labelColor=ddd"> &nbsp;
                    <img class="mb-2" src="https://img.shields.io/static/v1?label=%20&message=Visual%20Studio%20Code&color=007ACC&style=for-the-badge&logo=Visual%20Studio%20Code&logoColor=007ACC&labelColor=ddd"> &nbsp;
                </li>
            </ul>
        </div>
    </section>
