...
<body>
    ...
    <div class="wh-screen d-flex justify-content-center align-items-center bg-white text-center font-nunito-sans">
        <div class="col-10">
            <p class="h1">404 | Not Found</p>
            <button class="btn btn-red rounded-0 mt-4" onclick="history.back()"><i class="fa-solid fa-angles-left"></i>&nbsp; Back</button>
            <p class="small text-muted text-center mt-5">&copy; 2022 AkuOnline By Fikri Miftah</p>
